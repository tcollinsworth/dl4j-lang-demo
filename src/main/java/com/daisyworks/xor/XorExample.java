...
public class XorExample {
    public static void main(String[] args) {
        ...
        INDArray testInputs = Nd4j.zeros(1, 2);
        testInputs.putScalar(new int[]{0,0}, 0);
        testInputs.putScalar(new int[]{0,1}, 1);
        long start = System.nanoTime();

//        int[] results2 = net.predict(testInputs); //590us for 1 row
        int[] results2 = net.predict(input); // 670us for 4 rows
